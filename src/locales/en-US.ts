export default {
  ...
  // dictionary module
  dictionary_search_name_label: 'name',
  ...
  dictionary_edit_name: 'name',
  dictionary_edit_code: 'code',
  ...
  dictionary_sumbit_rule_name_message: 'name is not empty',
  ...
  // project module
  project_search_name_label: 'project name',
  project_column_name: 'project name',
  project_column_price: 'price',
  project_column_description: 'description',
  project_edit_name: 'name',
  project_edit_price: 'price',
  project_edit_description: 'description',
  project_sumbit_rule_name_message: 'name is not empty',
  project_sumbit_rule_price_message: 'price is not empty',

  // project item module
  project_item_search_name_label: 'project item name',
  project_item_column_name: 'project item name',
  project_item_column_price: 'price',
  project_item_column_category: 'category',
  project_item_column_description: 'description',
  project_item_edit_name: 'name',
  project_item_edit_category: 'categoty',
  project_item_edit_price: 'price',
  project_item_edit_description: 'description',
  project_item_sumbit_rule_name_message: 'name is not empty',
  project_item_sumbit_rule_category_message: 'categoty is not empty',
  project_item_sumbit_rule_price_message: 'price is not empty',

  // consumer module
  consumer_search_name_label: 'consumer name',
  consumer_column_name: 'name',
  consumer_column_stock: 'stock',
  consumer_column_price: 'price',
  consumer_column_description: 'description',
  consumer_edit_name: 'name',
  consumer_edit_price: 'price',
  consumer_edit_stock: 'stock',
  consumer_edit_description: 'description',
  consumer_sumbit_rule_name_message: 'name is not empty',
  consumer_sumbit_rule_stock_message: 'stock is not empty',
  consumer_sumbit_rule_price_message: 'price is not empty',
  ...
  route_project: 'project manage',
  route_project_item: 'project item manage',
  route_consumer: 'consumer manage',
};
